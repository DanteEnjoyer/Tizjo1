...
.SILENT all:
	...
	$(call perform_test,default,Default)
	$(call perform_test,nospec,"NO spec")
...
generate:
	...
	$(call generate_answers,default)
	$(call generate_answers,nospec)
...
merge:
	...
	$(call merge_test,default)
	$(call merge_test,nospec)
